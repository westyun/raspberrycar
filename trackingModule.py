...
try:
    while True:
        sLM = int(GPIO.input(leftmostled))
        sLL = int(GPIO.input(leftlessled))
        sCL = int(GPIO.input(centerled))
        sRL = int(GPIO.input(rightlessled))
        sRM = int(GPIO.input(rightmostled))

        ledcondition = [sLM, sLL, sCL, sRL, sRM]
